            ...
            <div class="card">
                ...
                <form action="{{route('branch.update',$branch->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control form-control-rounded {{$errors->has('name')?'is-invalid':''}}" id="input-6" placeholder="Enter Employee Name" value="{{ $branch->name }}">
