            ...
            <div class="card">
                ...
                <form action="{{route('attendance.update',$attendance->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="employee_name" class="form-control {{$errors->has('employee_name')?'is-invalid':''}}">
                            ...
                            @foreach($users as $user)
                                <option @if($user->id == $attendance->user_id) selected @endif value="{{ $user->id }}">{{ ucfirst($user->name) }} - [ {{ ucfirst($user->id) }} ]</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="date" class="form-control form-control-rounded {{$errors->has('date')?'is-invalid':''}}" id="input-6" placeholder="Enter Employee Name" value="{{$attendance->work_date}}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="time" name="clock_in" class="form-control form-control-rounded {{$errors->has('clock_in')?'is-invalid':''}}" id="input-6" value="{{$attendance->clock_in}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" name="clock_out" class="form-control form-control-rounded {{$errors->has('clock_out')?'is-invalid':''}}" id="input-6" value="{{$attendance->clock_out}}">
